...
# assign some rasters to variables
...
multiband = rasterio.open(raster_base_path + "multiband.tiff", "w", driver="Gtiff", width=band2.width,
...
falseColor = rasterio.open(raster_base_path + "falschfarben.tiff", "w", driver="Gtiff", width=band2.width,
